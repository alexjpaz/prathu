...
module.exports = (robot) ->
  ...
  cron '0 9-17 * * 1-5', 0.005, '@here is dev down?'
  cron '0 9-17 * * 1-5', 0.005, 'docs controllo'
  cron '0 9-17 * * 1-5', 0.05, 'Can someone you look at https://jira.move.com/browse/ADVP-'+Math.floor(Math.random() * (9000 - 1000 + 1)) + 9000
  cron '0 9-17 * * 1-5', 0.005, 'corrrelation id 6fe3b18d-b24a-45b7-85f6-caec586d73de on prod'
  cron '0 9-17 * * 1-5', 0.005, 'deploying profile api to prod'
  cron '0 9-17 * * 1-5', 0.005, "Is anyone using `dashboard.tphub.moveaws.com? I'm going to delete it."
  cron '0 9-17 * * 1-5', 0.01, "fucking controllo"
